...
app.config['MAIL_USERNAME'] = 'remyjnrmartin@gmail.com'  # Replace with your Gmail address
app.config['MAIL_PASSWORD'] = 'dxgx uoqe imdt mnwz'  # Replace with your 16-character app-specific-password
app.config['EXCHANGE_RATE_API_KEY'] = '3e45d76c024ebe058272497a'  # Replace with your exchangerate-api.com API key
db = SQLAlchemy(app)
